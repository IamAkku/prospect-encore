...
def insertlogic():
    ...
    insqry=f"insert into prospect values({prospId},'{prospName}','{prospPhone}','{prospAddress}','{interestedModel}','{interestedColor}','{dateOfVisit}','{priority}','{gender}')"
